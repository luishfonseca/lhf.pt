import { mysqlTable, varchar, text, boolean, timestamp, primaryKey, index } from "drizzle-orm/mysql-core";
...
export const post = mysqlTable('Post', {
    ...
    createdAt: timestamp('created_at', { fsp: 2 }).notNull().default(sql`now(2)`)
}, table => ({
...
export const tagsOnPosts = mysqlTable('TagsOnPosts', {
